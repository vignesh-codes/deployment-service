...
func (svc EventLoggerService) GetDeploymentsByNamespace(namespace string) ([]map[string]interface{}, error) {
...
func (svc EventLoggerService) GetTenantKubernetesInfo(namespace string) (map[string]interface{}, error) {
